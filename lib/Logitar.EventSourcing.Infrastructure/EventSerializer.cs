...
public class EventSerializer : IEventSerializer
{
  ...
  public EventSerializer()
  {
    ...
    RegisterConverter(new EventIdConverter());
  ...
  public IEvent Deserialize(IEventEntity entity)
  {
    Type eventType = Type.GetType(entity.EventType) ?? throw new EventTypeNotFoundException(entity);

    return (IEvent?)JsonSerializer.Deserialize(entity.EventData, eventType, _options)
  ...
  public string Serialize(IEvent change)
  {
