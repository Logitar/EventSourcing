...
/// <summary>
/// Represents the identifier of a stream of events.
/// </summary>
public readonly struct StreamId
{
  ...
  public StreamId(Guid value) : this(Convert.ToBase64String(value.ToByteArray()).ToUriSafeBase64())
  {
  }
  ...
  /// <summary>
  /// Creates a new instance of the <see cref="StreamId"/> struct from a random <see cref="Guid"/>.
  /// </summary>
  /// <returns>The created instance.</returns>
  public static StreamId NewId() => new(Guid.NewGuid());
  ...
  public override bool Equals([NotNullWhen(true)] object? obj) => obj is StreamId id && id.Value == Value;
  /// <summary>
