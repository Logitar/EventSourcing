...
/// <summary>
/// The handler for <see cref="AddressDeletedEvent"/> events.
/// </summary>
internal class AddressDeletedEventHandler : INotificationHandler<AddressDeletedEvent>
{
  /// <summary>
  ...
  /// <summary>
  /// Initializes a new instance of the <see cref="AddressDeletedEventHandler"/> class with the specified arguments.
  /// </summary>
  /// <param name="context">The identity database context.</param>
  /// <param name="logger">The logger instance.</param>
  public AddressDeletedEventHandler(IdentityContext context, ILogger<AddressDeletedEventHandler> logger)
  {
    _context = context;
    _logger = logger;
  }
