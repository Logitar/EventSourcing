...
/// <summary>
/// The handler for <see cref="AddressCreatedEvent"/> events.
/// </summary>
internal class AddressCreatedEventHandler : INotificationHandler<AddressCreatedEvent>
{
  /// <summary>
  ...
  /// <summary>
  /// Initializes a new instance of the <see cref="AddressCreatedEventHandler"/> class with the specified arguments.
  /// </summary>
  /// <param name="context">The identity database context.</param>
  /// <param name="logger">The logger instance.</param>
  public AddressCreatedEventHandler(IdentityContext context, ILogger<AddressCreatedEventHandler> logger)
  {
    _context = context;
    _logger = logger;
  }
  ...
  public async Task Handle(AddressCreatedEvent notification, CancellationToken cancellationToken)
  {
    try
    {
      ...
      AddressEntity address = new(notification, user);
