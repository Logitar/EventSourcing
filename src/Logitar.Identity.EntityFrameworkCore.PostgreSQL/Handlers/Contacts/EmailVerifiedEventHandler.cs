...
/// <summary>
/// The handler for <see cref="EmailVerifiedEvent"/> events.
/// </summary>
internal class EmailVerifiedEventHandler : INotificationHandler<EmailVerifiedEvent>
{
  /// <summary>
  ...
  /// <summary>
  /// Initializes a new instance of the <see cref="EmailVerifiedEventHandler"/> class with the specified arguments.
  /// </summary>
  /// <param name="context">The identity database context.</param>
  /// <param name="logger">The logger instance.</param>
  public EmailVerifiedEventHandler(IdentityContext context, ILogger<EmailVerifiedEventHandler> logger)
  {
    _context = context;
    _logger = logger;
  }
