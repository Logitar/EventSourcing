...
/// <summary>
/// The base contact information creation input data.
/// </summary>
public abstract record CreateContactInput
{
  /// <summary>
  /// Gets or sets the identifier of the user owning the postal address..
  /// </summary>
