...
/// <summary>
/// The query raised to retrieve a list of phone numbers.
/// </summary>
...
internal record GetPhonesQuery(bool? IsArchived, bool? IsVerified, string? Search, Guid? UserId,
  PhoneSort? Sort, bool IsDescending, int? Skip, int? Take) : IRequest<PagedList<Phone>>;
