...
/// <summary>
/// The validator used to validate instances of the <see cref="AddressUpdatedEvent"/> class.
/// </summary>
internal class AddressUpdatedValidator : ContactUpdatedValidator<AddressUpdatedEvent>
{
  /// <summary>
  /// Initializes a new instance of the <see cref="AddressUpdatedValidator"/> class.
  /// </summary>
  public AddressUpdatedValidator()
  {
    ...
    IRuleBuilder<AddressUpdatedEvent, string?> postalCodeRules = RuleFor(x => x.PostalCode).NullOrNotEmpty()
      .MaximumLength(byte.MaxValue);
    ...
    IRuleBuilder<AddressUpdatedEvent, string?> regionRules = RuleFor(x => x.Region).NullOrNotEmpty()
      .MaximumLength(byte.MaxValue);
