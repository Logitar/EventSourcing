...
/// <summary>
/// The handler for <see cref="SetDefaultAddressCommand"/> commands.
/// </summary>
internal class SetDefaultAddressCommandHandler : IRequestHandler<SetDefaultAddressCommand, Address>
{
  /// <summary>
  /// The actor context.
  /// </summary>
  ...
  /// <summary>
  /// Initializes a new instance of the <see cref="SetDefaultAddressCommandHandler"/> class using the specified arguments.
  /// </summary>
  ...
  public SetDefaultAddressCommandHandler(IActorContext actorContext,
  ...
  /// <returns>The default postal address.</returns>
  ...
  public async Task<Address> Handle(SetDefaultAddressCommand command, CancellationToken cancellationToken)
  {
    ...
    address.SetDefault(_actorContext.ActorId);
